  ...
  return (
    <div className="flex min-h-screen">
      ...
      >
        ...
        <div className="h-16 flex items-center px-3 border-b border-sidebar-border">
          <div className="flex items-center gap-3 overflow-hidden">
            <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-primary flex items-center justify-center shadow-lg shadow-primary/25">
      ...
      >
        ...
        <div className="h-16 flex items-center justify-between px-4 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl">SendIt</span>
          </div>
          <Button
            variant="ghost"
            size="icon"
        ...
        <div className="p-3 border-t border-sidebar-border space-y-1">
          ...
          <button
            onClick={handleLogout}
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl w-full text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-all duration-200"
          >
      ...
      <div className="flex-1 flex flex-col lg:ml-16">
        {/* Desktop Header */}
        <header className="hidden lg:flex h-16 items-center gap-4 px-6 glass-sidebar sticky top-0 z-40">
        ...
        {/* Mobile Header */}
        <header className="flex lg:hidden h-16 items-center gap-4 px-4 glass-sidebar sticky top-0 z-30">
          <Button
            variant="ghost"
            size="icon"
